...
<sec:authorize access="hasRole('ROLE_TEACHER') or hasRole('ROLE_ADMIN') hasRole('ROLE_ACDEMIC')"><a href="teacher" class="button button-3d button-primary button-rounded">教师页面</a></sec:authorize>
