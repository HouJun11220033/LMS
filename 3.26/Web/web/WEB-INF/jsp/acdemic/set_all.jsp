...
<html>
    ...
    <body style="text-align: left">
        <br> <br> <br>
        <a style="width: 100px"  onclick="xs_course_sz()" class="easyui-linkbutton">安排下学期课程</a>
        <a  style="width:120px " onclick="xs_bj_sz()" class="easyui-linkbutton">安排下学期开课班级</a>
           ...
           <div style="float: left">
            ...
            <div  style="float: left;padding-top: 100px;padding-left: 5px;padding-right: 5px">
                ...
                <div  id='xuehao_all1' style="padding:5px;height:auto">
                 ...
                 年级:<select  id="cs_nj" class="zs_cs_nj" style="width: 100px"></select>
                </div>
...
<!--                        <th data-options="field:'classId',hidden:'true',align:'left'">班序号</th>-->
        ...
        <div  style="display: none;height: 350px" id="kechengbiao_div">
              <table id="course_list" style="width:350px;height:auto" class="easyui-datagrid" title="课程表" 
