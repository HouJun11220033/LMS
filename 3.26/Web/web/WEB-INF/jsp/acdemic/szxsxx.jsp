        ...
        <p>你可以批准删除临时学生信息.</p>
         <div  id='xs_ls_xy' style="padding:5px;height:auto">
             ...
             选择年级:<select  id="xs_xs_xy_3" class="zs_xs_nj1" style="width: 100px"></select>
                ...
                <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick="removeit_lsxs_xuehao()">批量删除</a>  
         </div>
      
        <table id="dg_stu" title="临时学生信息" style="width:900px;height:auto"
               data-options="rownumbers:true,singleSelect:true,pagination:true,fitColumns:true,toolbar:'#xs_ls_xy',method:'get'">
            <thead>
                <tr>
